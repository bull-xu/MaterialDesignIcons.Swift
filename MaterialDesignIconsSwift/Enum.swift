...
public enum MaterialDesignIcons: String {
	...
	case accountStarVariant = "\u{F018}"
	...
	case arrowCompress = "\u{F615}"
	case arrowCompressAll = "\u{F044}"
	case arrowDown = "\u{F045}"
	case arrowDownBold = "\u{F046}"
	...
	case battery = "\u{F079}"
	case battery_10 = "\u{F07A}"
	case battery_20 = "\u{F07B}"
	case battery_30 = "\u{F07C}"
	case battery_40 = "\u{F07D}"
	case battery_50 = "\u{F07E}"
	case battery_60 = "\u{F07F}"
	case battery_70 = "\u{F080}"
	case battery_80 = "\u{F081}"
	case battery_90 = "\u{F082}"
	case batteryAlert = "\u{F083}"
	case batteryCharging = "\u{F084}"
	case batteryCharging_100 = "\u{F085}"
	case batteryCharging_20 = "\u{F086}"
	case batteryCharging_30 = "\u{F087}"
	case batteryCharging_40 = "\u{F088}"
	case batteryCharging_60 = "\u{F089}"
	case batteryCharging_80 = "\u{F08A}"
	case batteryCharging_90 = "\u{F08B}"
	...
	case brightness_1 = "\u{F0DA}"
	case brightness_2 = "\u{F0DB}"
	case brightness_3 = "\u{F0DC}"
	case brightness_4 = "\u{F0DD}"
	case brightness_5 = "\u{F0DE}"
	case brightness_6 = "\u{F0DF}"
	case brightness_7 = "\u{F0E0}"
	...
	case formatHeader_1 = "\u{F26B}"
	case formatHeader_2 = "\u{F26C}"
	case formatHeader_3 = "\u{F26D}"
	case formatHeader_4 = "\u{F26E}"
	case formatHeader_5 = "\u{F26F}"
	case formatHeader_6 = "\u{F270}"
	...
	case nuke = "\u{F6A3}"
	case numeric = "\u{F3A0}"
	case numeric_0Box = "\u{F3A1}"
	case numeric_0BoxMultipleOutline = "\u{F3A2}"
	case numeric_0BoxOutline = "\u{F3A3}"
	case numeric_1Box = "\u{F3A4}"
	case numeric_1BoxMultipleOutline = "\u{F3A5}"
	case numeric_1BoxOutline = "\u{F3A6}"
	case numeric_2Box = "\u{F3A7}"
	case numeric_2BoxMultipleOutline = "\u{F3A8}"
	case numeric_2BoxOutline = "\u{F3A9}"
	case numeric_3Box = "\u{F3AA}"
	case numeric_3BoxMultipleOutline = "\u{F3AB}"
	case numeric_3BoxOutline = "\u{F3AC}"
	case numeric_4Box = "\u{F3AD}"
	case numeric_4BoxMultipleOutline = "\u{F3AE}"
	case numeric_4BoxOutline = "\u{F3AF}"
	case numeric_5Box = "\u{F3B0}"
	case numeric_5BoxMultipleOutline = "\u{F3B1}"
	case numeric_5BoxOutline = "\u{F3B2}"
	case numeric_6Box = "\u{F3B3}"
	case numeric_6BoxMultipleOutline = "\u{F3B4}"
	case numeric_6BoxOutline = "\u{F3B5}"
	case numeric_7Box = "\u{F3B6}"
	case numeric_7BoxMultipleOutline = "\u{F3B7}"
	case numeric_7BoxOutline = "\u{F3B8}"
	case numeric_8Box = "\u{F3B9}"
	case numeric_8BoxMultipleOutline = "\u{F3BA}"
	case numeric_8BoxOutline = "\u{F3BB}"
	case numeric_9Box = "\u{F3BC}"
	case numeric_9BoxMultipleOutline = "\u{F3BD}"
	case numeric_9BoxOutline = "\u{F3BE}"
	case numeric_9PlusBox = "\u{F3BF}"
	case numeric_9PlusBoxMultipleOutline = "\u{F3C0}"
	case numeric_9PlusBoxOutline = "\u{F3C1}"
	...
	case robot = "\u{F6A8}"
	case rocket = "\u{F463}"
	case rotate_3d = "\u{F464}"
	case rotate_90 = "\u{F6A9}"
	...
	case stepBackward_2 = "\u{F4D6}"
	case stepForward = "\u{F4D7}"
	case stepForward_2 = "\u{F4D8}"
	...
	case unfoldLess = "\u{F54E}"
	case unfoldMore = "\u{F54F}"
	case ungroup = "\u{F550}"
	case unity = "\u{F6AE}"
	case untappd = "\u{F551}"
	case update = "\u{F6AF}"
