...
public enum MaterialDesignIcons: String {
	...
	case heartHalfOutline = "\u{F6DD}"
	case heartHalfPart = "\u{F6DE}"
	case heartHalfPartOutline = "\u{F6DF}"
	...
	case network = "\u{F6F2}"
	case networkDownload = "\u{F6F3}"
	case networkQuestion = "\u{F6F4}"
	case networkUpload = "\u{F6F5}"
	case newBox = "\u{F394}"
